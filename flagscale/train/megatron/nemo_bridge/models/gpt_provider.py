...
from megatron.nemo_bridge.models.model_provider import ModelProviderMixin
from megatron.nemo_bridge.models.transformer_config import TransformerConfig
from megatron.nemo_bridge.utils import fusions
from megatron.nemo_bridge.utils.vocab_utils import calculate_padded_vocab_size
...
def transformer_engine_full_layer_spec(config: "GPTModelProvider") -> ModuleSpec:
    ...
    """
    from megatron.nemo_bridge.models.gpt_full_te_layer_autocast_spec import (
