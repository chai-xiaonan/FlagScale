...
from megatron.nemo_bridge.utils.instantiate_utils import InstantiationMode, instantiate
from megatron.nemo_bridge.utils.yaml_utils import safe_yaml_representers
